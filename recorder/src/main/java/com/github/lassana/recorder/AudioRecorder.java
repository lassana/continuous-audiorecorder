...
public class AudioRecorder {
  ...
  public static class MediaRecorderConfig {
    ...
    public static final MediaRecorderConfig DEFAULT = new MediaRecorderConfig(
      /* 64 Kib per second            */
      64 * 1024,
      /* Stereo                       */
      2,
  ...
  public static AudioRecorder build(
    @NonNull final Context context, @NonNull final String targetFileName
  ) {
  ...
  public static AudioRecorder build(
    ...
    AudioRecorder rvalue = new AudioRecorder(context, targetFileName, mediaRecorderConfig, false);
